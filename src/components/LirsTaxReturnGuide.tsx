...
import csvRaw from '@/assets/lirs-tax-return-guide.csv?raw';
...
export function LirsTaxReturnGuide() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">How to File Tax Returns on LIRS</h1>
        <p className="text-muted-foreground mt-1">
          Follow these steps to file your Lagos State tax returns through the LIRS portal.
        </p>
      </div>
